...
function PointsCalculator() {
        ...
        if (scrapedData) {
            ...
            if (isFacilitator) {
                ...
                updatedData.points = {
                    ...
                    milestonePoints,
                    total:
                        updatedData.points.gameBadges +
                        updatedData.points.triviaBadges +
                        updatedData.points.skillBadges +
                        milestonePoints,
                };
    ...
    const recentBadges =
        scrapedData?.badges?.filter((badge) => {
                        ...
                        <div className="flex items-center space-x-2">
                            <input
                                ...
                                onChange={(e) => {
                                    ...
                                    if (profileUrl) {
                                        console.log(
                                            "Syncing with backend for facilitator:",
                                            newValue
                                        );
                                            ...
                                            <div className="grid grid-cols-2 gap-4 mb-6">
                                                ...
                                                <div className="bg-gray-50 p-4 rounded-lg">
                                                    ...
                                                    <p className="text-3xl font-bold text-google-green">
                                                        {scrapedData?.points?.gameBadges || 0}
                                                    </p>
                                                </div>
                                                <div className="bg-gray-50 p-4 rounded-lg">
                                                    <p className="text-base text-gray-600">
                                                    ...
                                                    <p className="text-3xl font-bold text-google-yellow">
                                                        {scrapedData?.points?.triviaBadges || 0}
                                                    </p>
                                                </div>
                                                <div className="bg-gray-50 p-4 rounded-lg">
                                                    <p className="text-base text-gray-600">
                                                    ...
                                                    <p className="text-3xl font-bold text-google-red">
                                                        {scrapedData?.points?.skillBadges || 0}
                                                    </p>
                                                </div>
                                                {isFacilitator &&
                                                    scrapedData?.points?.milestonePoints > 0 && (
                                                        <div className="bg-gray-50 p-4 rounded-lg">
                                                            <p className="text-base text-gray-600">
                                                                Points from Milestone{" "}
                                                                {
                                                                    scrapedData?.milestoneProgress
                                                                        ?.currentMilestone
                                                                }
                                                            </p>
                                        ...
                                        <div className="space-y-6">
                                            <div className="bg-white rounded-lg p-4">
                                                ...
                                                <ul className="list-disc list-inside text-base text-gray-700 space-y-2">
                                                    ...
                                                    <li>
                                                        Badges Earned: {recentBadges?.length || 0}
                                                    </li>
                                                ...
                                                <div className="mt-4 pt-4 border-t border-gray-200">
                                                    ...
                                                    {(scrapedData?.points?.total || 0) < 85 && (
                                                        <p className="text-xs text-gray-500 mt-1">
                                                            {(scrapedData?.points?.total || 0) >= 75
                                                                ? `${
                                                                      85 -
                                                                      (scrapedData?.points?.total ||
                                                                          0)
                                                                  } points to Tier 5`
                                                                : (scrapedData?.points?.total ||
                                                                      0) >= 65
